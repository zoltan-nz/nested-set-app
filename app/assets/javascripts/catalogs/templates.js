...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push(escapeExpression(((stack1 = helpers.render || (depth0 && depth0.render)),stack1 ? stack1.call(depth0, "catalogs", "catalog", options) : helperMissing.call(depth0, "render", "catalogs", "catalog", options))));
  data.buffer.push("\n        ");
  hashTypes = {};
  hashContexts = {};
